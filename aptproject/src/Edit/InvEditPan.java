...
public class InvEditPan extends JPanel implements ActionListener,ItemListener{
	...
	public void regist(){
		...
		sql.append("(INVOICE_ID, INVOICE_CODE, INVOICE_TAKER,  APTUSER_ID, COMPANY_ID) values ");
		...
		try {
			...
			pstmt.setInt(1,Integer.parseInt(tf_code.getText()));
			pstmt.setString(2,tf_taker.getText());
			pstmt.setString(3,"1234"); //나중에 아이디 값뽑아야됨
